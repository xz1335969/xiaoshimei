...
from xiaoshimei.xiaoshimei_plugins._globals import TYPELIST, EXTRA_MODULES, EXTRA_MODULES3, EXTRA_MODULES2, randomlist, \
    overrandom, sqlquery, get_qq
...
def authority(group_id, extra_name=None) -> int | tuple[int]:
    """
    检查群功能是否开启
    :param group_id: 群号
    :param extra_name: 模块名称，None代表全部
    :return: 返回是否开启，0代表未开启，1代表开启，2代表限时开启
    """
